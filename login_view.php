...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/img_peruri.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <br/>
  <br/>
  ...
  <!-- <div class="login-logo">
    <a href="index.php" style="color: blue;"><b>Sistem Informasi Dokumen</b><br/>></a>
  </div> -->
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Copyright &copy; BANGPRO - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
