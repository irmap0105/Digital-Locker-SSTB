...
<head>
  ...
  <link rel="icon" href="<?= base_url('assets_style/image/logo-peruri.png'); ?>">
  <title><?php echo $title_web; ?> | BANGPRO </title>
  ...
  <![endif]-->
  <!-- Google Font -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300timesnewroman,400timesnewroman,600timesnewroman">
  <!-- offline -->
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <nav class="navbar navbar-static-top">
        <!-- <img src="assets_style/image/LOGO BARU PERURI.png" width="50" height="40" alt="logo" /> -->
